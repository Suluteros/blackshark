...
import threading
import datetime
import random, socket, threading, time, datetime, urllib, re, sys, optparse, os
global term
...
time.sleep(2)
print(Fore.GREEN+"<------------------------------------------------------->")
print(Fore.GREEN+"Version 1.0	  (2021/9/26)     C0d3d by Zero_BlackShark ")
print(Fore.GREEN+"┌───────────────────────────────────────────────────────┐")
print(Fore.GREEN+"│              Layer 7 ddos powerfull tool              │")
print(Fore.GREEN+"├───────────────────────────────────────────────────────┤")
print(Fore.GREEN+"│          New stuff:                                   │")
print(Fore.GREEN+"│          [+] Optimization                             │")
print(Fore.GREEN+"│          [+] Changed Output                           │")
print(Fore.GREEN+"│          [+] Added Url Parser                         │")
print(Fore.GREEN+"├───────────────────────────────────────────────────────┤")
print(Fore.GREEN+"│ Link: https://github.com/ZeroBlackShark/CC-BlackShark │")
print(Fore.GREEN+"└───────────────────────────────────────────────────────┘")
print("")
time.sleep(1)
	...
	while True:
		...
		for _ in range(conn - len(socket_list)):
			try:
				...
				pass
nums = 0
def checking(lines,socks_type,ms,rlock,):#Proxy checker coded by Zero_BlackShark
	global nums
	global proxies
...
def check_socks(ms):#Coded by Zero_BlackShark
	global nums
	thread_list=[]
